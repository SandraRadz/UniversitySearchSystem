...
@register.filter
def get_project_count(dictionary, key):
    """
    Gets number of projects in category, otherwise returns 0.
    :param dictionary: key - id of category, value - count of project in that category
    :param key: id of category (industry id or technology id)
    :return:
    """
